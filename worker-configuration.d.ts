/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 663d0a20425ffa164460929b7e3be59e)
...
interface __BaseEnv_Env {
	...
	RUN_CHANNEL: DurableObjectNamespace<import("./src/server").RunChannel>;
	PROJECT_CHAT: DurableObjectNamespace<import("./src/server").ProjectChat>;
	RUN_WORKFLOW: Workflow<Parameters<import("./src/server").RunWorkflow['run']>[0]['payload']>;
	SUITE_WORKFLOW: Workflow<Parameters<import("./src/server").SuiteWorkflow['run']>[0]['payload']>;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "RunChannel" | "ProjectChat";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISABLE_SIGNUP" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "ENCRYPTION_KEY" | "OPENAI_API_KEY" | "ANTHROPIC_API_KEY" | "GOOGLE_API_KEY">> {}
}
